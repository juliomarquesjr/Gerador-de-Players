                        ...
                        <ul class="media-list dropdown-list">
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb"
                                     src="<?php echo base_url('/assets/images/photos/user1.png'); ?>" alt="">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb"
                                     src="<?php echo base_url('/assets/images/photos/user2.png'); ?>" alt="">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb"
                                     src="<?php echo base_url('/assets/images/photos/user3.png'); ?>" alt="">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb"
                                     src="<?php echo base_url('/assets/images/photos/user4.png'); ?>" alt="">
