...
$streamid = $id;				// This is needed only if you run SHOUTcast Server 2
...
$(function(){
var autoref = function(){ $('#radiostats').load('ouvintes.php?ip=<?php echo "$HOST"; ?>&porta=<?php echo "$PORTA"; ?>&versao=<?php echo "$versao"; ?>').fadeIn("fast"); };
...
<script type="text/javascript">
$(function(){
var autoref = function(){ $('#radio_musica').load('musica.php?ip=<?php echo "$HOST"; ?>&porta=<?php echo "$PORTA"; ?>&versao=<?php echo "$versao"; ?>').fadeIn("fast"); };
setInterval(autoref, <?php echo $reloadtime * 1000; ?>);
autoref();
});
</script>

<table  border="0" cellpadding="0" cellspacing="0" style="background-image: url(fundo1.png); background-repeat:no-repeat; height: 35px; width: 249px; font-family: Verdana, Geneva, sans-serif; font-size: 9px; font-weight: bold; text-align: center;  ">
  <tr>
    <td width="33"><div id='player'></div>

</td>
    <td width="34"><a href="<?  echo $radio; ?>/listen.pls" target="_blank"><img src="winamp.png" width="22" height="24" alt="Winamp"></a></td>
    <td width="131">
...
direction="left" SCROLLDELAY="300" loop="1000" width="90%"><div style="  font-family: Verdana, Geneva, sans-serif; font-size: 9px; padding-top: 5px;  text-align: center;"  id="radio_musica">
    ...
    <td width="51"><div style=" height: 20px; width: 50px; font-family: Verdana, Geneva, sans-serif; font-size: 15px;  text-align: center;" padding-top: 0px;  id="radiostats">
    </div></td>
  </tr>
</table>
